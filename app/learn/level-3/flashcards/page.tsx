 ...
 */
export default function Level3FlashcardsPage() {
  ...
  const playAudio = () => {
    const audioUrl = `/audio/${currentWord.category.toLowerCase()}/${currentWord.id.replace('l3-', '')}.mp3`;
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <h1 className="text-3xl font-bold text-gray-900">Simple Words Flashcards</h1>
              <p className="text-gray-600 mt-1">
                Card {currentIndex + 1} of {simpleWords.length}
              </p>
            </div>
            <button
        ...
        <div className="mb-8">
          ...
          <div className="flex justify-between mt-2 text-sm text-gray-600">
            ...
            <span>{simpleWords.length - currentIndex - 1} remaining</span>
          </div>
        </div>
        ...
        <div className="mb-8">
          ...
          >
            ...
            >
              ...
              <div
                className={`absolute inset-0 w-full h-full bg-gradient-to-br from-blue-500 to-blue-600 rounded-2xl shadow-2xl border-4 border-blue-700 flex flex-col items-center justify-center p-8 backface-hidden rotate-y-180 ${
                  isFlipped ? "visible" : "invisible"
                }`}
              >
                <p className="text-blue-100 text-lg mb-2">English</p>
                <h2 className="text-5xl font-bold text-white mb-4">
                  {currentWord.english}
                </h2>
                <p className="text-blue-100 text-lg mb-1">Pronunciation</p>
        ...
        {currentIndex === simpleWords.length - 1 && (
          <div className="bg-green-50 border-2 border-green-200 rounded-xl p-6 text-center">
            ...
            <p className="text-green-700 mb-4">
              You've completed all {simpleWords.length} cards! You marked {knownCards.size} as known.
            </p>
