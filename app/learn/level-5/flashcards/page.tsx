 ...
 * Dari phrase on front, flip to reveal English meaning
 */
export default function Level5FlashcardsPage() {
    ...
    return (
      <div className="bg-gray-50 py-4">
        <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-gray-600 mb-8">Phrase flashcards are being prepared.</p>
  ...
  const currentPhrase = dariPhrases[currentIndex];
  const progress = ((currentIndex + 1) / dariPhrases.length) * 100;

  const nextCard = () => {
    if (currentIndex < dariPhrases.length - 1) {
  ...
  return (
    ...
    <div className="bg-gray-50 py-4">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-3">
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <h1 className="text-3xl font-bold text-gray-900">Phrase Flashcards</h1>
              <p className="text-gray-600 mt-1">
                Card {currentIndex + 1} of {dariPhrases.length}
              </p>
            </div>
            <button
          ...
          >
            ...
            >
              ...
              >
                ...
                <h2 className="text-4xl font-bold text-gray-900 mb-6" dir="rtl">
                  {currentPhrase.dari}
                </h2>
              ...
              <div
                className={`absolute inset-0 w-full h-full bg-gradient-to-br from-yellow-500 to-yellow-600 rounded-2xl shadow-2xl border-4 border-yellow-700 flex flex-col items-center justify-center p-8 backface-hidden rotate-y-180 ${
                  isFlipped ? "visible" : "invisible"
                }`}
              >
                <p className="text-yellow-100 text-sm mb-2">English</p>
                <h2 className="text-3xl font-bold text-white mb-4 text-center">
                  {currentPhrase.english}
                </h2>
                <p className="text-yellow-100 text-sm mb-1">Pronunciation</p>
        ...
        {currentIndex === dariPhrases.length - 1 && (
          <div className="bg-green-50 border-2 border-green-200 rounded-xl p-6 text-center">
            ...
            <div className="flex gap-3 justify-center">
              ...
              <Link href="/learn/level-5/quiz" className="px-6 py-3 bg-white border-2 border-green-600 text-green-600 rounded-lg hover:bg-green-50 transition-colors">
                Take Quiz
              </Link>
            </div>
          </div>
