        ...
        <div className="mb-3">
          ...
          >
            ...
            >
              ...
              >
                <p className="text-gray-500 text-sm mb-2">What letter is this?</p>
              ...
              >
                <p className="text-red-100 text-sm mb-2">Letter Name</p>
                <h2 className="text-4xl font-bold text-white mb-4">
                  {currentLetter.name}
                </h2>
                <p className="text-red-100 text-sm mb-1">Sound</p>
