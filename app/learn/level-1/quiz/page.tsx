...
export default function Level1QuizPage() {
  ...
  useEffect(() => {
    if (quizComplete && !progressSaved) {
      ...
      if (passed && user?.id) {
        saveLevelProgress("level-1", percentage, "level-2").then(() => {
            ...
            {passed && (
              <div className="bg-green-50 border-2 border-green-200 rounded-xl p-6 mb-6">
                ...
                <p className="text-green-700">
                  You've unlocked Level 2: Letter Forms
                </p>
              </div>
            )}
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              {passed ? (
                <>
                  <Link
                    href="/learn/level-2"
                    className="px-8 py-4 bg-gradient-to-r from-green-500 to-green-600 text-white rounded-xl hover:from-green-600 hover:to-green-700 transition-colors font-semibold"
                  >
                    Continue to Level 2 →
                  </Link>
                  <Link
        ...
        <div className="mb-4">
          ...
          <div className="flex items-center justify-between mb-4">
            <div>
              ...
              <h1 className="text-3xl font-bold text-gray-900">Alphabet Test</h1>
