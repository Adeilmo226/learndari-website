...
export default function FlashcardsPage() {
  ...
  const nextCard = () => {
    if (currentIndex < transportationVocab.length - 1) {
  ...
  const playAudio = () => {
    const audioUrl = `/audio/transportation/${currentWord.id}.mp3`;
  ...
  return (
    ...
    <div className="min-h-screen bg-gray-50 py-12">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-600 mt-1">
                Card {currentIndex + 1} of {transportationVocab.length}
              </p>
            </div>
        ...
        {currentIndex === transportationVocab.length - 1 && (
