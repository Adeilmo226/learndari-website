  ...
  return (
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
      ...
      <div className="grid md:grid-cols-2 gap-4 mb-4">
        <Link
          href="/vocab/greetings/flashcards"
      ...
      <div className="mb-3">
        <h2 className="text-2xl font-bold text-gray-900 mb-6">
          All Words ({greetingsVocab.length})
        </h2>
      </div>

      <div className="space-y-3">
        {greetingsVocab.map((word) => (
...
function VocabWordCard({ word }: { word: typeof greetingsVocab[0] }) {
  ...
  return (
    <div className="bg-white p-6 rounded-xl border-2 border-gray-200 hover:border-gray-300 transition-colors">
      <div className="flex items-center justify-between">
        ...
        <button
          onClick={() => playAudio(`/audio/phrases/${word.id}.mp3`)}
          disabled={isPlaying}
