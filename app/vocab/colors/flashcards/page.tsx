...
/**
 * Flashcards Mode
 * Interactive flashcard study mode for vocabulary
 */
export default function FlashcardsPage() {
   ...
   */
  const nextCard = () => {
    if (currentIndex < colorsVocab.length - 1) {
  ...
  const playAudio = () => {
    ...
    const audioUrl = `/audio/colors/${currentWord.id}.mp3`;
  ...
  return (
    <div className="bg-gray-50 py-4">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-600 mt-1">
                Card {currentIndex + 1} of {colorsVocab.length}
              </p>
            </div>
        ...
        {/* Completion Message */}
        {currentIndex === colorsVocab.length - 1 && (
